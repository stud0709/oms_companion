...
## Decrypting Data
*omsCompanion* is continuously monitoring your clipboard. If it finds a text starting with `oms00_`, it will generate an QR code sequence out of it, empty the clipboard and show a pop-up window:
